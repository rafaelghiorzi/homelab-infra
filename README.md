...
[x] Add Nginx reverse proxy for port routing  
...
[x] Portainer for Docker management  
[] LGTM for log monitoring  
[x] Nginx Proxy Manager for reverse proxy management  
[x] Nextcloud for file sharing and backup  
[] Jellyfin for media server  
[x] Immich for photo management  
[] PiHole for ad blocking and DNS  
[x] Glance for dashboard and monitoring  
...
[x] Cloudflare tunnel and nginx for external access  
